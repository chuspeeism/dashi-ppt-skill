...
- **不把你锁死在网页里**：如果你厌倦了 AI 时代"用网页伪装的假 PPT"，一键导出成真实的 PPTX——逐节点还原、文字保持可编辑，导出引擎 [html-deck-to-pptx](skills/dashiai-ppt/project/packages/html-deck-to-pptx) 以 MIT 协议开源。
