  ...
  },
  {
    ...
    "controls": [
      ...
      },
      {
        ...
        "min": 0,
        "step": 1,
        "describe": "配图槽位数量（自前向后填充；0 = 纯文字步骤）",
        "max": 4,
        "publicKey": "imageCount",
        "publicLabel": "图片数量",
  ...
  },
  {
    ...
    "controls": [
      ...
      },
      {
        ...
        "max": 5,
        "step": 1,
        "describe": "飞轮环节数量（角度自适应：3→120°、4→90°、5→72°）",
